...
class StoreDiscountCodeRequest extends FormRequest
{
    ...
    {
        return [
            'discount_amount.required' => 'Số tiền giảm giá là trường bắt buộc.',
            'discount_amount.numeric' => 'Số tiền giảm giá phải là kiểu số.',
            'discount_amount.min' => 'Số tiền giảm giá phải lớn hơn hoặc bằng :min.',
