            ...
            <div class="">
                <div class="table-responsive">
                    <table class="table project-list-table table-nowrap align-middle table-borderless">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('/assets/images/companies/img-1.png') }}" alt=""
                                        class="avatar-sm"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="{{ asset('/assets/images/companies/img-2.png') }}" alt=""
                                        class="avatar-sm"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="{{ asset('/assets/images/companies/img-3.png') }}" alt=""
                                        class="avatar-sm"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="{{ asset('/assets/images/companies/img-4.png') }}" alt=""
                                        class="avatar-sm"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="{{ asset('/assets/images/companies/img-5.png') }}" alt=""
                                        class="avatar-sm"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="{{ asset('/assets/images/companies/img-6.png') }}" alt=""
                                        class="avatar-sm"></td>
                                <td>
