                                    ...
                                    <ul class="list-inine ps-0 mb-4">
                                            ...
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="{{ asset('/assets/images/companies/img-1.png') }}" alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="{{ asset('/assets/images/companies/img-2.png') }}" alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="{{ asset('/assets/images/companies/img-3.png') }}" alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-inline mb-4">
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ asset('/assets/images/small/img-4.jpg') }}" class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ asset('/assets/images/small/img-5.jpg') }}" class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ asset('/assets/images/small/img-6.jpg') }}" class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <ul class="list-unstyled user-list validate" id="taskassignee">
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="{{ asset('/assets/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                ...
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="{{ asset('/assets/images/users/avatar-3.jpg') }}" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="{{ asset('/assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="{{ asset('/assets/images/users/avatar-5.jpg') }}" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="{{ asset('/assets/images/users/avatar-6.jpg') }}" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="{{ asset('/assets/images/users/avatar-7.jpg') }}" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="{{ asset('/assets/images/users/avatar-8.jpg') }}" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                            </ul>
                        </div>
