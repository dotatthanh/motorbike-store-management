    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div class="me-3">
                        <img src="{{ asset('/assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle img-thumbnail">
                    </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="{{ asset('/assets/images/small/img-2.jpg') }}" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
                                ...
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="{{ asset('/assets/images/small/img-6.jpg') }}" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
                                        <div class="align-self-center overflow-hidden me-auto">
                                            <div>
                                ...
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="{{ asset('/assets/images/small/img-1.jpg') }}" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
